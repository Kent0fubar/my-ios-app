...
export const MOCK_USERS: UserProfile[] = [
    ...
    },
    {
        ...
        age: 24,
        location: '東京都世田谷区',
        bio: '都内で活動中のボーカリストです！エモ・ガレージロックが大好き🎸 一緒に熱いステージを作れるメンバーを探しています。',
        instruments: ['vocal'],
        genres: ['rock', 'punk'],
        tags: ['live_active', 'original'],
        skillLevel: 'intermediate',
        lookingFor: ['band'],
        imageUrl: 'https://images.unsplash.com/photo-1524250502761-1ac6f2e30d43?w=400&h=600&fit=crop',
        distance: 3.2,
        isVerified: true,
        isPremium: false,
    },
    {
        ...
        age: 27,
        location: '東京都港区',
        bio: 'ジャズ・フュージョンを得意とするドラマーです。テクニカルなセッションから歌伴まで幅広く対応します🥁',
        instruments: ['drums'],
        genres: ['jazz', 'funk'],
        tags: ['improv', 'theory_lover'],
        skillLevel: 'advanced',
        lookingFor: ['session', 'band'],
        imageUrl: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?w=400&h=600&fit=crop',
        distance: 2.1,
        isVerified: true,
        isPremium: true,
    },
    {
        ...
        age: 22,
        location: '東京都目黒区',
        bio: 'バイオリンでポップスやアニソンのカバーをしています🎻 バンドにストリングスの彩りを加えませんか？',
        instruments: ['violin'],
        genres: ['pop', 'classical'],
        tags: ['cover', 'recording'],
        skillLevel: 'intermediate',
        lookingFor: ['collaboration', 'session'],
        imageUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=600&fit=crop',
        distance: 4.5,
    ...
    },
    {
        ...
        age: 31,
        location: '神奈川県横浜市',
        bio: 'ファンキーなベースラインなら任せてください！スラップ大好き。グルーヴを極めたいベーシストです🔥',
        instruments: ['bass'],
        genres: ['funk', 'rnb'],
        tags: ['improv', 'pro_oriented'],
        skillLevel: 'professional',
        lookingFor: ['band', 'session'],
        imageUrl: 'https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=400&h=600&fit=crop',
        distance: 12.0,
        isVerified: true,
        isPremium: false,
    },
    {
        ...
        age: 20,
        location: '東京都武蔵野市',
        bio: '宅録中心に活動しているシンガーソングライターです。私の曲にアレンジを加えてくれるパートナーを募集中♪',
        instruments: ['songwriter', 'vocal'],
        genres: ['indie', 'pop'],
        tags: ['dtm', 'original'],
        skillLevel: 'intermediate',
        lookingFor: ['songwriter', 'collaboration'],
        imageUrl: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=400&h=600&fit=crop',
        distance: 8.4,
        isVerified: true,
        isPremium: false,
    },
    {
        ...
        age: 25,
        location: '東京都渋谷区',
        bio: 'テックハウスやメロディックテクノを作っているDJ/Producerです🎧 ボーカル素材を探しています！',
        instruments: ['dj', 'producer'],
        genres: ['electronic'],
        tags: ['dtm', 'compose'],
        skillLevel: 'advanced',
    ...
    },
    {
        ...
        age: 29,
        location: '東京都中野区',
        bio: 'ソウルフルなサックスを奏でます🎷 渋いブルースセッションができる仲間と出会いたいです。',
        instruments: ['saxophone'],
        genres: ['blues', 'jazz'],
        tags: ['improv', 'live_active'],
        skillLevel: 'advanced',
        lookingFor: ['session', 'band'],
        imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=600&fit=crop',
        distance: 5.2,
    ...
    },
    {
        ...
        age: 26,
        location: '東京都杉並区',
        bio: '速弾きから泣きのソロまで、メタル愛に溢れるギタリストです。ツインギターの相方募集中！⚡',
        instruments: ['guitar'],
        genres: ['metal', 'rock'],
        tags: ['pro_oriented', 'live_active'],
        skillLevel: 'advanced',
        lookingFor: ['band'],
        imageUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=600&fit=crop',
        distance: 6.8,
    ...
    },
    {
        ...
        age: 23,
        location: '東京都品川区',
        bio: 'R&B/Neo-Soulな鍵盤弾きです🎹 オシャレでスムースな音作りが得意です。',
        instruments: ['piano', 'keyboard'],
        genres: ['rnb', 'pop'],
        tags: ['theory_lover', 'recording'],
        skillLevel: 'advanced',
        lookingFor: ['collaboration', 'session'],
        imageUrl: 'https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?w=400&h=600&fit=crop',
        distance: 4.1,
        isVerified: true,
        isPremium: false,
    },
    {
        ...
        age: 21,
        location: '東京都新宿区',
        bio: 'パンクロック命のドラマーです！シンプルかつパワフルなビートでフロアを揺らしましょう🤘',
        instruments: ['drums'],
        genres: ['punk', 'rock'],
        tags: ['live_active', 'casual'],
        skillLevel: 'intermediate',
        lookingFor: ['band', 'session'],
        imageUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=600&fit=crop',
        distance: 3.7,
